...
export function compile(filePath: string, options: CompilerOptions = defaultOptions): { sourceFile: SourceFile, diagnostics: ReadonlyArray<Diagnostic>, program: ts.Program } {
